...
if __name__ == "__main__":
    ...
    while True:    
        ...
        sf1_seg1_cable_1   = 0 # .005*np.sin(0.5*np.pi*t)
        sf1_seg1_cable_2   = 0 # .005*np.sin(0.5*np.pi*t)
        sf1_seg2_cable_1   = 0 # .005*np.sin(0.5*np.pi*t+1)
        sf1_seg2_cable_2   = 0 # .005*np.sin(0.5*np.pi*t+1)
        sf1_seg3_cable_0   = 0 # .00*np.sin(0.5*np.pi*t)
        sf1_seg3_cable_1   = 0 # .005*np.sin(0.5*np.pi*t+2)
        sf1_seg3_cable_2   = 0 # .005*np.sin(0.5*np.pi*t+2)
        sf1_gripper_pos    = 0 # np.abs(np.sin(np.pi*t))
        
        sf2_seg1_cable_1   = 0 #.005*np.sin(0.5*np.pi*t+5)
        sf2_seg1_cable_2   = 0 #.005*np.sin(0.5*np.pi*t+5)
        sf2_seg2_cable_1   = 0 #.005*np.sin(0.5*np.pi*t+1+5)
        sf2_seg2_cable_2   = 0 #.005*np.sin(0.5*np.pi*t+1+5)
        sf2_seg3_cable_0   = .005*np.sin(0.5*np.pi*t+5)
        ...
        p0,o0 = env.get_ee_state() #得到机械臂末端位姿 end effector 
